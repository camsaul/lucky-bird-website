             ...
             [:div#about
              (container-and-row
               [:body
                ...
                [:div#indi
                	[:h1 "Cameron Saul"]
                	[:h2 [:a.img {:href "https://twitter.com/ael1as"}[:img {:src "images/cambossiest.png" :name "Cam Saul"}]] [:i "Bird master, 1337 hacker, known to many as DJ Ael1as"]]
                [:A	[:p
                ...
                [:div#indi
                	[:h1 "Noah Sidman-Gale"]
                	[:h2 [:a.img {:href "https://twitter.com/Noahtorious"}[:img {:src "images/noahpic.jpg" :name "Noah Sidman-Gale"}]][:i "Pigeon whisperer, Bay Area sherpa, community creator"]]
                	[:p
                	
                	 "Noah has been a lover of mobile since 2009 when he and Cam made their first iOS app together at UC Davis.  He earned his stripes in user acquisition, community building, and business development going through" [:a {:href "http://500.co/"} " 500 Startups "]  "with" [:a {:href "http://make.switchcam.com/?ref=noah"} " Switchcam "] ", and then at" [:a {:href "https://www.safeshepherd.com/?ref=noah"} " Safe Shepherd "] "as employee #1.  He has mad skills at Super Smash Bros. (N64 version of course) and claims that if he were a ninja turtle hed be Leonardo."]
                ]
                
                
                [:div#indi
                	[:h1 "Lucky"]
                	[:h2 [:a.img {:href "http://www.deterapigeon.com/21-amazing-facts-about-pigeons.htm"}[:img {:src "images/luckycute.png" :name "Lucky the pigeon"}]] [:i "Maker of nests, destroyer of pigs, kinda like a puppy with wings"]]
                	[:p
